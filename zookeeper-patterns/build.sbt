name := "zookeeper-patterns"

organization := "com.loopfor.zookeeper"

version := "2.0-SNAPSHOT"

description := "Scala Patterns for ZooKeeper"
...
scmInfo := Some(ScmInfo(
  url("https://github.com/davidledwards/zookeeper/tree/release-" + version.value + "/zookeeper-patterns"),
